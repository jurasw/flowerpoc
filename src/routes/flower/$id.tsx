...
function FlowerMessageCard({
  ...
  return (
    <article className="relative z-10 mx-auto w-full max-w-xl rounded-[2rem] border border-white/10 bg-[#100d0f]/90 p-5 shadow-2xl shadow-black/40 backdrop-blur-xl sm:max-w-2xl sm:p-7 md:p-9 lg:bg-white/[0.04] lg:min-h-0">
      ...
      <h1 className="mt-5 font-serif text-3xl font-medium leading-[1.08] text-white sm:text-4xl md:text-5xl">
      ...
      <blockquote className="mt-7 break-words font-serif text-xl leading-relaxed text-stone-50 sm:text-2xl md:text-3xl">
...
function FlowerViewPage() {
  ...
  return (
    <div className="relative min-h-dvh overflow-x-hidden bg-[radial-gradient(circle_at_50%_22%,#171316_0%,#0f0c0e_50%,#080708_100%)] text-stone-100">
      ...
      <main className="relative z-10 mx-auto w-full max-w-xl px-4 pb-10 sm:max-w-2xl sm:px-8 lg:max-w-4xl lg:px-12 lg:pb-12 xl:max-w-5xl xl:px-16">
        <div className="pointer-events-none fixed inset-x-0 top-0 z-0 h-[72svh] px-4 pt-3 sm:px-8 lg:pointer-events-auto lg:static lg:z-auto lg:h-auto lg:px-0 lg:pt-5">
        ...
        <section className="relative z-10 lg:-mt-2">
          ...
          <div className="mx-auto mt-4 flex w-full max-w-xl flex-wrap items-center justify-between gap-x-4 gap-y-3 sm:max-w-2xl">
